        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="post" action="{{route('categorias.store')}}">
                  {{ csrf_field() }}
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="nome" name="nome" placeholder="Nome da categoria">
                  </div>
                </div>
